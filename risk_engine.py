...
RISK_THRESHOLDS = {
    ...
    "min_token_age_sec": 15,         # Minimum token age (15 seconds) — prevents evaluation of brand-new tokens, except runners
...
class TokenRiskAnalyzer:
    ...
    def analyze_token(
        ...
        # 5. Token age risk — check minimum age to avoid brand new tokens
